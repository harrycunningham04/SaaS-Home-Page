    ...
    <header className="fixed top-0 left-0 z-50 w-full py-10">
      <div className="container flex h-14 items-center max-lg:px-5">
        <a href="/" className="lg:hidden flex-1 cursor-pointer z-2">
          <img src="/images/xora.svg" alt="Xora Logo" width={155} height={55} />
        </a>

        <div
          className={clsx(
            "w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:h-full max-lg:bg-s2 transition-opacity duration-500",
          ...
          <div className="w-full max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            ...
            <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[290px] -translate-y-1/2 rotate-90">
              ...
              <img
                ...
                width={960}
                height={380}
                className="absolute inset-0 mixed-blend-soft-light opacity-5"
              />
            </div>
          </div>
        </div>
